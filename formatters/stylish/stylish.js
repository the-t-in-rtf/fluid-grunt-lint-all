...
module.exports = function(results) {
    ...
    // return total > 0 ? chalk.reset(output) : `${results.length} files lint free`;
    return total > 0 ? chalk.reset(output) : `${results.length} ${pluralize("file", results.length)} lint free`;
};
